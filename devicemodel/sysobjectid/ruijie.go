...
func RuiJieDeviceModel(sysObjId string) *devicemodel.DeviceModel {
	...
	oidMap := map[string]map[string]string{
		...
		".1.3.6.1.4.1.4881.1.1.10.1.286":  {"platform": stringPlatform, "model": "S2910-24GT4XS-UP-H"},
		...
		".1.3.6.1.4.1.4881.1.1.10.1.739":  {"platform": stringPlatform, "model": "S5310-48GT4XS"},
		".1.3.6.1.4.1.4881.1.1.10.1.74":  {"platform": stringPlatform, "model": "S5650-27XG"},
		".1.3.6.1.4.1.4881.1.1.10.1.740":  {"platform": stringPlatform, "model": "S6120-20XS4VS2QXS"},
		...
		".1.3.6.1.4.1.4881.1.1.10.1.818":  {"platform": stringPlatform, "model": "S5310-24GT4XS-P-E"},
